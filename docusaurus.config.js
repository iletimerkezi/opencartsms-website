...
const config = {
  title: 'Ücretsiz Opencart SMS Eklentisi - İleti Merkezi',
  tagline: 'Opencart SMS modülü, kullanıcılarınıza daha kaliteli bir müşteri deneyimi sunmanız için tasarlanmıştır. Hemen deneyin.',
  url: 'https://opencartsms.com',
  baseUrl: '/',
  onBrokenLinks: 'throw',
  ...
  projectName: 'opencartsms-website', // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        ...
        title: '',
        logo: {
          alt: 'Opencart SMS Logo',
          src: 'img/opencart-logo.png',
        },
        items: [
          // {
          //   type: 'doc',
      ...
      footer: {
        ...
        copyright: `Opencart SMS T.C. Bilgi Teknolojileri ve İletişim Kurumu (BTK) tarafından yetkilendirilmiş işletmeci olan eMarka İletişim ve Bilgi Teknolojileri A.Ş. ye ait bir markadır.`,
      },
      prism: {
